...
export function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await fetch(
        "https://script.google.com/macros/s/AKfycbyNXt9wJPgDo07DNa5mYmWMDm-dqw-ts7Dl6qXs9xMTGBRnFMLtRpmtEeQ2pEu4XpA6/exec",
        {
          method: "POST",
          mode: "no-cors",
          headers: {
        ...
        <AnimatePresence mode="wait">
          {submitStatus === "idle" ? (
            ...
            >
              ...
              <motion.h2 
                className="text-6xl md:text-8xl mb-20 bg-gradient-to-r from-purple-400 via-pink-400 to-pink-300 bg-clip-text text-transparent tracking-tight"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
