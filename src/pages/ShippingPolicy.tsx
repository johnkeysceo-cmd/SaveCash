...
export default function ShippingPolicy() {
  return (
    <LegalPageLayout title="Shipping Policy" currentPath="/shipping-policy">
      ...
      <div className="space-y-8 text-base text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p style={{ color: "#4a4a4a", fontSize: "17px", lineHeight: "1.8", margin: "0 0 28px 0" }}>Contact privacy.savecash@gmail.com within 7 days of expected delivery with order number and photos (if applicable). We'll work with the carrier for resolution.</p>
        </section>
        ...
        <section>
          ...
          <p style={{ color: "#4a4a4a", fontSize: "17px", lineHeight: "1.8", margin: "0 0 28px 0" }}>Updates posted on our Shipping Policy page.</p>
        </section>

        <section>
          <h2 style={{ color: "#1a1a1a", fontSize: "22px", fontWeight: 600, margin: "48px 0 24px 0", lineHeight: "1.4" }}>15. Contact</h2>
          <p style={{ color: "#4a4a4a", fontSize: "17px", lineHeight: "1.8", margin: "0 0 28px 0" }}>Email: privacy.savecash@gmail.com</p>
