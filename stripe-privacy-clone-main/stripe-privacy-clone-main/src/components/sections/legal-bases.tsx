...
const LegalBasesSection = () => {
  return (
    <section id="legal-bases-for-processing-data" className="scroll-mt-24 max-w-[800px]">
      ...
      <p className="mb-6 text-base font-normal text-[#4a5568] leading-[1.6]">
        ...
        . For some jurisdictions, there may be additional legal bases, which are outlined in the Jurisdiction-Specific Provisions section below.
      </p>

      <h3 className="mt-6 mb-4 text-xl font-semibold text-[#1a1f36]">
        a. Contractual and Pre-Contractual Business Relationships.
      </h3>
      <p className="text-base font-normal text-[#4a5568] leading-[1.6]">
      ...
      <ul className="mt-4 list-disc space-y-3 pl-[16px] text-base font-normal text-[#4a5568] leading-[1.6]">
        ...
        <li>
          Sharing of Personal Data with third party service providers that offer services on our behalf and business partners that help us in operating our business (
          <a href="#" className="text-[#635bff] hover:text-[#0a2540] hover:underline">
            Learn More
          </a>
          ).
...
export default LegalBasesSection;