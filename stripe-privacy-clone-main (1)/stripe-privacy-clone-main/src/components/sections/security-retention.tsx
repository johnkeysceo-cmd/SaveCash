...
const SecurityAndRetentionSection = () => {
  return (
    <div id="security-and-retention" className="scroll-mt-24 max-w-[800px]">
      ...
      <p className="text-[16px] font-normal leading-[1.6] text-[#4a5568] mb-4">
        We make reasonable efforts to provide a level of security appropriate to the risk associated with the processing of your Personal Data. We maintain <span className="font-medium">organizational, technical, and administrative measures</span> designed to protect the Personal Data covered by this Policy from unauthorized access, destruction, loss, alteration, or misuse. <a href="#" className="text-[#635BFF] hover:text-[#0a2540] hover:underline">Learn More</a>. Unfortunately, no data transmission or storage system can be guaranteed to be 100% secure.
      </p>
      ...
      <ul className="list-disc pl-4 mb-4 text-[16px] font-normal leading-[1.6] text-[#4a5568] space-y-2">
        ...
        <li>
          For fraud monitoring, detection, and prevention.
        </li>
        <li>
          To meet tax, accounting, and financial reporting obligations.
        </li>
        <li>
      ...
      <p className="text-[16px] font-normal leading-[1.6] text-[#4a5568] mb-4">
        In cases where we keep your Personal Data, we do so in accordance with any limitation periods and record retention obligations imposed by applicable law. <a href="#" className="text-[#635BFF] hover:text-[#0a2540] hover:underline">Learn More</a>.
      </p>
    </div>
  );
};

export default SecurityAndRetentionSection;