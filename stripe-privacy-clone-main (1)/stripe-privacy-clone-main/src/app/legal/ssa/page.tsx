          ...
          <article className="space-y-8">
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li><strong>"Account"</strong> means your SaveCash account through which you access our Services.</li>
                <li><strong>"API"</strong> means our application programming interface that allows you to integrate our Services into your platform.</li>
                <li><strong>"Chargeback"</strong> means a reversal of a transaction initiated by a Cardholder's issuing bank.</li>
                <li><strong>"Fees"</strong> means all fees, charges, and costs associated with your use of our Services, as set forth in your pricing plan.</li>
                <li><strong>"Merchant"</strong> means any individual or entity that uses our Services to accept payments.</li>
                <li><strong>"Payment Data"</strong> means any data relating to payment transactions, including card numbers, account numbers, and transaction amounts.</li>
                <li><strong>"Services"</strong> means all payment processing, financial, and related services provided by SaveCash.</li>
                <li><strong>"Transaction"</strong> means a payment processed through our Services.</li>
              </ul>
            </section>

            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">2. Services Provided</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Credit and debit card processing through major card networks (Visa, Mastercard, American Express, Discover)</li>
                <li>Digital wallet processing (Apple Pay, Google Pay, Samsung Pay)</li>
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">3. Merchant Obligations</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                As a Merchant using our Services, you agree to the following obligations and responsibilities:
              </p>
              
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">3.1 Compliance Requirements</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                You must comply with all applicable laws, regulations, and industry standards, including:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Payment Card Industry Data Security Standard (PCI DSS)</li>
                <li>General Data Protection Regulation (GDPR) and similar privacy laws</li>
                ...
                <li>Fair Credit Reporting Act (FCRA) and similar credit reporting requirements</li>
                <li>Electronic signature regulations (E-SIGN Act, UETA)</li>
              </ul>

              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">3.2 Business Information</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                ...
                <li>Names and identification of beneficial owners and authorized representatives</li>
                <li>Complete description of products and services you offer</li>
                <li>Website URL and customer-facing materials</li>
                <li>Any licenses or permits required for your business activities</li>
              </ul>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                You must promptly notify us of any changes to this information within 10 business days of such changes.
              </p>

              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">3.3 Transaction Handling</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                You agree to handle all transactions in accordance with best practices and applicable regulations:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Only process transactions for legitimate goods and services</li>
                <li>Obtain proper authorization before processing any payment</li>
                <li>Provide clear and accurate transaction descriptions</li>
                <li>Maintain records of all transactions for at least 7 years</li>
                <li>Honor all refund requests in a timely manner</li>
                <li>Respond to customer inquiries and disputes promptly</li>
                <li>Never process transactions on behalf of another merchant</li>
                <li>Not split transactions to avoid fees or limits</li>
              </ul>
            </section>

            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">4. Fees and Payment Terms</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">4.1 Transaction Fees</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                Transaction fees are assessed on each payment you process through our Services:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Per-transaction processing fee (typically 2.9% + $0.30 for credit/debit cards)</li>
                <li>ACH transfer fees (typically $0.50 per transaction)</li>
                <li>Wire transfer fees (typically $25 per domestic wire, $50 per international wire)</li>
                <li>Currency conversion fees (typically 1% of transaction amount)</li>
                <li>Cross-border transaction fees for international payments</li>
              </ul>

              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">4.2 Subscription and Monthly Fees</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">4.3 Other Fees</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">4.4 Fee Changes and Notification</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">4.5 Payment and Settlement</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">5. Payment Card Processing</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                When you process payment card transactions through our Services, the following terms apply:
              </p>
              
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">5.1 Authorization and Capture</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                All card transactions must be properly authorized before you complete the sale. You agree to:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Obtain authorization for the exact amount of the transaction</li>
                <li>Verify the cardholder's identity when required</li>
                <li>Not charge a card unless you have authorization or approval</li>
                <li>Complete the transaction only after authorization is obtained</li>
                <li>Not split a single transaction into multiple smaller transactions</li>
                <li>Obtain additional authorization if the transaction amount changes</li>
              </ul>

              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">5.2 Card Network Rules</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                ...
                <li>Special rules for recurring transactions, subscriptions, and installment payments</li>
                <li>Refund and return policies</li>
                <li>Prohibited and restricted business practices</li>
              </ul>

              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">5.3 Chargebacks and Disputes</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                Cardholders may dispute transactions for various reasons. When a chargeback occurs:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>The disputed amount will be debited from your account</li>
                <li>We will assess a chargeback fee as set forth in our fee schedule</li>
                <li>You must respond to chargeback notices promptly and provide requested documentation</li>
                <li>Failure to respond may result in automatic chargeback loss</li>
                <li>Excessive chargeback rates may result in account restriction or termination</li>
              </ul>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">6. Security and Data Protection</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">6.1 PCI DSS Compliance</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                You must maintain PCI DSS compliance at all times if you handle, store, or process cardholder data:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Complete annual PCI DSS self-assessment questionnaires</li>
                <li>Undergo periodic PCI DSS security scans</li>
                <li>Implement and maintain security controls as required by PCI DSS</li>
                <li>Restrict access to cardholder data to only authorized personnel</li>
                <li>Use encryption for cardholder data both in transit and at rest</li>
                <li>Maintain secure network configurations and firewall protection</li>
                <li>Regularly test security systems and processes</li>
                <li>Maintain an information security policy for personnel</li>
              </ul>

              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">6.2 Data Handling Requirements</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                ...
                <li>Mask primary account numbers (PANs) in displays and logs</li>
                <li>Limit data retention to only what is necessary for business purposes</li>
                <li>Securely delete data when no longer needed</li>
                <li>Implement strong access controls and authentication for systems handling Payment Data</li>
                <li>Regularly update and patch all systems and software</li>
                <li>Monitor systems for security breaches and unauthorized access</li>
              </ul>

              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">6.3 Security Breach Notification</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                ...
                <li>All documentation requested by SaveCash or regulatory authorities</li>
              </ul>

              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">6.4 SaveCash Security Measures</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                SaveCash implements comprehensive security measures to protect data processed through our Services:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Level 1 PCI DSS certification and ongoing compliance</li>
                <li>End-to-end encryption of all Payment Data in transit and at rest</li>
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">7. Prohibited Activities</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">7.1 Prohibited Business Types</h3>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Illegal activities or businesses</li>
                <li>Adult content and services, including pornography and adult websites</li>
                <li>Gambling, including online casinos, sports betting, and lotteries</li>
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">7.2 Prohibited Activities</h3>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Money laundering or terrorist financing</li>
                <li>Fraudulent or deceptive business practices</li>
                <li>Processing transactions for another merchant (factoring)</li>
                <li>Circumventing transaction limits or fees</li>
                <li>Processing refunds to a different card than the original transaction</li>
                ...
                <li>Reverse engineering or unauthorized use of our APIs</li>
              </ul>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">8. Account Suspension and Termination</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                We may suspend or terminate your access to our Services under various circumstances:
              </p>
              
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">8.1 Suspension</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                We may suspend your account immediately and without prior notice if we have reasonable grounds to believe:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>You have violated this Agreement or any applicable laws</li>
                <li>Your account poses an unacceptable risk to SaveCash or other parties</li>
                <li>There is evidence of fraudulent or suspicious activity</li>
                <li>Your chargeback or refund ratio exceeds acceptable thresholds</li>
                <li>You have failed to pay Fees when due</li>
                <li>You have provided false, misleading, or incomplete information</li>
                <li>Required compliance certifications have expired or been revoked</li>
                <li>You are subject to legal action or regulatory investigation</li>
              </ul>

              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">8.2 Termination by Merchant</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">8.3 Termination by SaveCash</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                ...
                <li>You must cease all use of our APIs, trademarks, and intellectual property</li>
                <li>We may withhold funds as necessary to cover outstanding obligations</li>
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">8.4 Post-Termination Obligations</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                After termination, you must:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Return or destroy all SaveCash materials and confidential information</li>
                ...
                <li>Continue to fulfill obligations for transactions processed prior to termination</li>
                <li>Remain liable for chargebacks and disputes for up to 180 days post-termination</li>
              </ul>
            </section>

            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">9. Intellectual Property and Confidentiality</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">10. Warranties and Disclaimers</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                ...
                <li>All information provided to the other party is accurate and complete</li>
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">11. Limitation of Liability and Indemnification</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">12. Dispute Resolution and Governing Law</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">13. Intellectual Property and Anti-Competition Protections</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">13.1 Proprietary Technology and Trade Secrets</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Proprietary machine learning algorithms for savings detection and optimization</li>
                <li>Advanced fraud detection and prevention systems</li>
                <li>Risk assessment and credit analysis methodologies</li>
                <li>User experience designs, workflows, and interface elements</li>
                <li>Security protocols and data protection mechanisms</li>
                <li>Integration patterns and API architectures</li>
                <li>Business processes, operational procedures, and optimization strategies</li>
                <li>Customer data analytics and personalization engines</li>
                <li>Backend infrastructure, database schemas, and system architectures</li>
                <li>All source code, object code, and executable code</li>
                <li>Trademarks, service marks, brand names, logos, and trade dress</li>
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">13.2 Strict Prohibition on Competition and Copying</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
                By using SaveCash Services, you expressly agree that you will not, directly or indirectly:
              </p>
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>Copy, mimic, reverse engineer, or attempt to replicate any aspect of SaveCash's platform, services, or intellectual property</li>
                <li>Develop, create, fund, or participate in any competing financial technology business that offers similar services to SaveCash</li>
                <li>Use SaveCash Services, APIs, documentation, or any proprietary information to build competing products or services</li>
                <li>Scrape, crawl, or extract data from SaveCash platforms for use in competitive products</li>
                <li>Hire, recruit, or solicit SaveCash employees, contractors, or partners to work on competitive ventures</li>
                <li>Disclose, share, or transfer any proprietary information to competitors or potential competitors</li>
                <li>Create derivative works based on SaveCash's intellectual property</li>
                <li>Use SaveCash's trademarks, service marks, or branding in any manner that suggests endorsement or affiliation with competing products</li>
                <li>Engage in any activity that would enable a third party to compete with SaveCash using our proprietary technology or confidential information</li>
                <li>Participate in, support, or provide resources to any entity developing competing financial services</li>
              </ul>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">13.3 Market Position and Competitive Advantage</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-3 text-[var(--color-text-primary)] leading-relaxed">
                <li>State-of-the-art artificial intelligence capable of analyzing millions of transactions in real-time</li>
                <li>Proprietary savings algorithms that identify opportunities traditional methods cannot detect</li>
                <li>Industry-leading security infrastructure and fraud prevention systems</li>
                <li>Seamless integration capabilities with major financial institutions and payment networks</li>
                <li>Superior user experience design optimized for financial engagement and trust</li>
                <li>Scalable technology architecture built to serve millions of users globally</li>
                <li>Established partnerships with leading banks, card networks, and financial service providers</li>
                <li>Comprehensive regulatory compliance frameworks across multiple jurisdictions</li>
                <li>Vast proprietary datasets and analytics capabilities</li>
                <li>Proven track record of delivering measurable financial value to users</li>
              </ul>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">13.4 Injunctive Relief and Remedies</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold text-[var(--color-text-primary)] mt-8 mb-4">13.5 Survival of Obligations</h3>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">14. General Provisions</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-3xl font-semibold text-[var(--color-text-primary)] mt-12 mb-6">15. Contact Information</h2>
              <p className="text-[var(--color-text-primary)] leading-relaxed">
